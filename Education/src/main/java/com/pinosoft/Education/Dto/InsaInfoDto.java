...
public class InsaInfoDto {
	...
	public void setWrk_posb_date(Date wrk_posb_date) {
		this.wrk_posb_day = wrk_posb_date;
	}
	...
	public String toString() {
		return "InsaInfoDto [sabun=" + sabun + ", seq=" + seq + ", wrk_posb_day=" + wrk_posb_day + ", sugst_money="
